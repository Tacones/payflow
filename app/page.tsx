  ...
  return (
    <main>
      <nav className="nav">
        ...
        <div className="nav-links"><a href="#product">Product</a><a href="#pricing">Pricing</a><a href="#security">Security</a><button className="ghost">Sign in</button><button className="primary">Start for free</button></div>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-actions"><button className="primary large">Try PayFlow free</button><button className="secondary large">See how it works <span>→</span></button></div>
      ...
      <section className="security" id="security"><div><div className="eyebrow">PRIVACY BY DESIGN</div><h2>Your client data comes first.</h2><p>PayFlow is being built with account isolation, secure authentication, server-side secrets, and no public exposure of client or invoice records.</p></div><div className="security-list"><div>✓ Private workspace per account</div><div>✓ No bank credentials stored</div><div>✓ Secrets kept out of source code</div><div>✓ Stripe-ready architecture</div></div></section>
