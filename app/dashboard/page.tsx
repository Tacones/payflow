...
export default async function DashboardPage() {
  ...
  return <main className="app-shell">
    ...
    <section className="dashboard-page">
      <header className="dashboard-header"><div><div className="eyebrow">OVERVIEW</div><h1>Payment pulse</h1><p>Keep every invoice moving toward paid.</p></div><div className="header-actions"><UserButton/><a className="primary" href="/dashboard/invoices">Manage invoices</a></div></header>
